...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("LauncherProgram", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("LauncherProgram", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "56";
		app.meta["company"] = "AARECo";
		app.meta["file"] = "LauncherProgram";
		app.meta["name"] = "Launcher Program (Minesu)";
		...
		#elseif air
		app.window.title = "Launcher Program (Minesu)";
		#else
